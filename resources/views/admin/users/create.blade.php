    ...
    <div class="card">
        ...
        <form action="{{ route('users.store') }}" method="POST" id="create-user-form">
            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputPassword4" placeholder="Temporary Password" name="password" required value="{{ old('temp-password') }}">
                    </div>
                </div>
                @if ($errors->any())
            ...
            <div class="card-footer">
                <button type="button" class="btn btn-success btn-sm" id="save-user-btn">Save</button>
